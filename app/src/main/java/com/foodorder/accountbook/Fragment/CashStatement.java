 ...
 * Use the {@link CashStatement#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CashStatement extends Fragment {
     ...
     * @return A new instance of fragment CashStatement.
     */
    // TODO: Rename and change types and number of parameters
    public static CashStatement newInstance(String param1, String param2) {
        CashStatement fragment = new CashStatement();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cash_statement, container, false);
        fromDate = v.findViewById(R.id.cashStatementFromdate_et);
        ToDate = v.findViewById(R.id.cashStatementToDate_et);
        StatementBtn = v.findViewById(R.id.cashStatement_Btn);
        FromDate(v);
        ToDate(v);
        StatementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (is_empty == false) {
                    CashStatementDetails NAME = new CashStatementDetails();
