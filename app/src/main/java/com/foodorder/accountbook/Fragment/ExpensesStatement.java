 ...
 * Use the {@link ExpensesStatement#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ExpensesStatement extends Fragment {
     ...
     * @return A new instance of fragment ExpensesStatement.
     */
    // TODO: Rename and change types and number of parameters
    public static ExpensesStatement newInstance(String param1, String param2) {
        ExpensesStatement fragment = new ExpensesStatement();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_expenses_statement, container, false);
        fromDate = v.findViewById(R.id.expensesStatementFromdate_et);
        ...
        StatementBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(is_empty==false){
                    ExpensesStatementDetails NAME = new ExpensesStatementDetails();
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Expenses Activity");
    }
